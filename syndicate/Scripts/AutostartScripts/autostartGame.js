                ...
                for (let l = 0; l < count; l++) {
                    ...
                    for (var i = 1, row; row = table.rows[i]; i++) {
                        ...
                        for (var j = 0, col; col = row.cells[j]; j++) {
                            ...
                            var num = numbers[l];
                            if (tabInnertext == num) {
                                col.style.backgroundColor = "#d27322";
                               /* col.style.color = "red";*/
                            }
                        }
                    }
                    ...
                    for (var j = 0, col; col = row.cells[j]; j++) {
                        ...
                        if (tabInnertext == "0") {
                            ...
                            if (col.innerText != "" && col.innerText != '0') {
                                col.style.backgroundColor = "#FFCA2C";
                            }
                        }
                    }
                }
            ...
            if (selectRow != sessionNumber) {
                for (let i = 0; i < row1.cells.length; i++) {
                    if (row1.cells[i].innerText == randomNumber) {
                        row1.cells[i].style.backgroundColor = "#d27322";
                        if (status != "PageLoad") {
            ...
            if (selectRow != sessionNumber) {
                for (let i = 0; i < row2.cells.length; i++) {
                    if (row2.cells[i].innerText == randomNumber) {
                        row2.cells[i].style.backgroundColor = "#d27322";
                        if (status != "PageLoad") {
                            var audio = new Audio(source);
                            audio.autoplay = true;
                            audio.play();
            ...
            if (selectRow != sessionNumber) {
                for (let i = 0; i < row3.cells.length; i++) {
                    if (row3.cells[i].innerText == randomNumber) {
                        row3.cells[i].style.backgroundColor = "#d27322";
                        if (status != "PageLoad") {
                            var audio = new Audio(source);
                            audio.autoplay = true;
                            audio.play();
            ...
            if (selectRow != sessionNumber) {
                for (let i = 0; i < row4.cells.length; i++) {
                    if (row4.cells[i].innerText == randomNumber) {
                        row4.cells[i].style.backgroundColor = "#d27322";
                        if (status != "PageLoad") {
                            var audio = new Audio(source);
                            audio.autoplay = true;
                            audio.play();
            ...
            if (selectRow != sessionNumber) {
                for (let i = 0; i < row5.cells.length; i++) {
                    if (row5.cells[i].innerText == randomNumber) {
                        row5.cells[i].style.backgroundColor = "#d27322";
                        if (status != "PageLoad") {
                            var audio = new Audio(source);
                            audio.autoplay = true;
                            audio.play();
            ...
            if (selectRow != sessionNumber) {
                for (let i = 0; i < row6.cells.length; i++) {
                    if (row6.cells[i].innerText == randomNumber) {
                        row6.cells[i].style.backgroundColor = "#d27322";
                        if (status != "PageLoad") {
                            var audio = new Audio(source);
                            audio.autoplay = true;
                            audio.play();
            ...
            if (selectRow != sessionNumber) {
                for (let i = 0; i < row7.cells.length; i++) {
                    if (row7.cells[i].innerText == randomNumber) {
                        row7.cells[i].style.backgroundColor = "#d27322";
                        if (status != "PageLoad") {
                            var audio = new Audio(source);
                            audio.autoplay = true;
                            audio.play();
            ...
            if (selectRow != sessionNumber) {
                for (let i = 0; i < row8.cells.length; i++) {
                    ...
                    if (row8.cells[i].innerText == randomNumber) {
                        row8.cells[i].style.backgroundColor = "#d27322";
                        if (status != "PageLoad") {
                            var audio = new Audio(source);
                            audio.autoplay = true;
                            audio.play();
            ...
            if (selectRow != sessionNumber) {
                for (let i = 0; i < row9.cells.length; i++) {
                    if (row9.cells[i].innerText == randomNumber) {
                        row9.cells[i].style.backgroundColor = "#d27322";
                        if (status != "PageLoad") {
                            var audio = new Audio(source);
                            audio.autoplay = true;
                            audio.play();
            ...
            if (newdata[w].WinningName == 'FULLHOUSE') {
                ...
                for (let loop = 0; loop < countlength; loop++) {
                    if (newdata[loop].WinningName == "FULLHOUSE" && (Temp != newdata[loop].Name || newdata[loop] !== Place)) {
                        ...
                        var name_tk = "TNO:" + TNumber + " (By " + name + " )";
                        ...
                        for (var i = 0, row; row = tableIteration.rows[i]; i++) {
                            ...
                            if (rowID == null || rowID == undefined) {
                                ...
                                innertable.className = "table table-sm border table-borderless p-0 m-0"
                                ...
                                nam.className = "badge rounded-pill bg-light text-dark";
                                ...
                                btn.type = "button";
                                btn.className = " btn btn-xs-long bg-success rounded-pill text-light";
                                btn.value = "view";
                                btn.id = "FullHouse" + loop;
                                cellBtn.appendChild(btn);
                                cellBtn.className = "p-0 m-0";
                ...
                var Temp = "";
                    for (let loop = 0; loop < countlength; loop++) {
                        if (newdata[loop].WinningName == "FULLSHEET" && Temp != newdata[loop].Name) {
                            Temp = newdata[loop].Name;
                            var Fullsheet = document.getElementById("FullSheet");
                ...
                var Temp = "";
                    for (let loop = 0; loop < countlength; loop++) {
                        if (newdata[loop].WinningName == "HALFSHEET" && Temp != newdata[loop].Name) {
                            Temp = newdata[loop].Name;
                            var Halfsheet = document.getElementById("Halfsheet");
                ...
                /*$("#QuickFive").find("tr:gt(0)").remove();*/
                    for (let loop = 0; loop < countlength; loop++) {
                        if (newdata[loop].WinningName == "FIRSTFIVE") {
                            ...
                            nam.innerText = "TN0:" + newdata[loop].TicketNumber.replace("TicketNo", "") + " ( By " + newdata[loop].CustomerName + " )";
                            nam.className = "badge rounded-pill bg-light text-dark";
                            cellNameT.appendChild(nam);
                ...
                if (checkwinnersSession('FIRSTSEVEN') == false) {
                    for (let loop = 0; loop < countlength; loop++) {
                        if (newdata[loop].WinningName == "FIRSTSEVEN") {
                            ...
                            nam.innerText = "TKNo:" + newdata[loop].TicketNumber.replace("TicketNo", "") + " ( By " + newdata[loop].CustomerName + " )";
                            nam.className = "badge rounded-pill bg-light text-dark";
                            cellNameT.appendChild(nam);
