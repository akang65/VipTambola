...
<body style="background-color: #9CC7DA">
    <form id="form1" runat="server">
        ...
        <div id="mainDiv" style="border: 0px solid grey;">
            ...
            <div class="timeDateDiv" name="themeColorEl" style="margin-top: 3px;">
                <button class="transBtn1" style="outline: none;">Month</button>
                <button class="transBtn1" style="outline: none;">Day</button>
                <button class="transBtn1" style="outline: none;">Year</button>
            </div>

            <div class="timeDateDiv" name="themeColorEl">
                <asp:TextBox ID="TextBoxMonth" runat="server" class="inp" placeholder="Month" type="number" Style="outline: none;"></asp:TextBox>
                <asp:TextBox ID="TextBoxDay" runat="server" class="inp" placeholder="Day" type="number" Style="outline: none;"></asp:TextBox>
                <asp:TextBox ID="TextBoxYear" runat="server" class="inp" placeholder="Year" type="number" Style="outline: none;"></asp:TextBox>
            </div>

            <div class="timeDateDiv" name="themeColorEl">
                <button class="transBtn1" style="outline: none;">Hour</button>
                <button class="transBtn1" style="outline: none;">Minute</button>
                <button class="transBtn1" style="outline: none;">Second</button>
            </div>

            <div class="timeDateDiv" name="themeColorEl">
                <asp:TextBox ID="TextBoxhour" runat="server" class="inp" placeholder="Hour" type="number" Style="outline: none;"></asp:TextBox>
                <asp:TextBox ID="TextBoxMin" runat="server" class="inp" placeholder="Minute" type="number" Style="outline: none;"></asp:TextBox>
                <asp:TextBox ID="TextBoxSec" runat="server" class="inp" placeholder="Second" type="number" Style="outline: none;"></asp:TextBox>
            </div>

            <div class="timeDateDiv" name="themeColorEl">
              <%--  <asp:TextBox ID="TextBoxAmPm" runat="server" class="inp" placeholder="AM" value="PM"></asp:TextBox>--%>
                  <asp:DropDownList ID="DropDownListAmPm" ClientIDMode="Static" class="inp" runat="server">
            ...
            <asp:DropDownList ID="DropDownListFullHouse" ClientIDMode="Static" CssClass="" class="dropDown" runat="server">
                <asp:ListItem Selected="True" Value="1">House Full 1</asp:ListItem>
