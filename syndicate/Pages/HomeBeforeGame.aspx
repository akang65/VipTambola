...
<body>
    <form id="form1" runat="server">
        ...
        <div class="gradient-syndicate">
            <%--<h1 class="text-center text-light">Vip Tambola</h1>--%>
            <img src="../Content/images/logo-no-background.png" style="width:65%; height:30%" class=" rounded mx-auto d-block" />
            <d class="container">
                ...
                <div class="container">
                    ...
                    <div class="col-6">
                        <div class="text-center">
                            <asp:Button ID="ButtonWhatsapp" class="mt-2 text-light form-control form-control-sm bg-success" runat="server" Style="font-size: 12px" Text="Join Whats app Group" Font-Size="Small" OnClick="ButtonWhatsapp_Click" />
                        </div>
                    </div>
                    <div class="col-6">
                        <div class="text-center">
                            <asp:Button ID="ButtonAgentLists" class="mt-2 text-light form-control form-control-sm bg-success" runat="server" Style="font-size: 12px" Text="Agents list" Font-Size="Small" OnClick="ButtonAgentLists_Click" />
                        </div>
                    </div>
                </div>
                </div>
                            ...
                            <div class="card card-Trans">
                                <div class="row mt-3">
                                    <div class="col-4 text-center">
                                        <asp:Button ID="ButtonCheckAllTicket" CssClass="btn btn-warning btn-sm" runat="server" Text=" View Tickets" OnClick="ButtonCheckAllTicket_Click" />
                                    </div>
                                    <div class="col-6">
                                    ...
                                    <div class="col-2">
                                        <div class="align-item-start">
                                            <button type="button" id="btn-search" onclick="searchTable();" class="btn btn-primary btn-sm">
